...
$create_tb = "CREATE TABLE users (user_id int(6),first_name varchar(15),last_name varchar(15), user varchar(15), password varchar(32),avatar varchar(70), last_login TIMESTAMP, failed_login INT(3), last_created INT(3), PRIMARY KEY (user_id));";
...
$insert = "INSERT INTO users VALUES
	...
	('6','user','user','user1',MD5('letmein'),'NULL', NOW(), '0', '1');";
